...
SDL_Surface *icon;
icon_font=TTF_OpenFont("/home/carsten/nas/IT/MyProjects/assets/fonts/vector/fontawesome-webfont.ttf", 50);
SDL_Color font_color_icon = {255,255,255,255};

icon=TTF_RenderGlyph_Blended(icon_font, 0xf17b , font_color_icon);
//icon = SDL_LoadBMP("/home/carsten/nas/IT/MyProjects/assets/logos/SDL2.bmp");
